...
test('convert xml with nested cross reference with custom cross Reference key', () => {
    const xmlString = `
        <?xml version="1.0" encoding="utf-8"?>  
        <note name="1212"  importance="high" logged="true" x_note="23">
        <title>Happy</title>
         <todo>Work</todo>
         <todo>Play</todo>
        </note>
        <note name="23" importance="high" logged="true">
        </note>
        <note importance="high" logged="true">
        </note>
        <person x_note="1212">
        </person>`;
    const resolvedJSON = xmlPathResolver(xmlString, { crossRefKey: "name", crossReference: /x_(.*)/ });
    let expectedResponse = {
        "_declaration": {
            "_attributes": {
                "version": "1.0",
